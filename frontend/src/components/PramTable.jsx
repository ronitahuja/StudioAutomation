                    ...
                    <tr className="border bg-gray-50">
                        <td className="border p-2">
                            <input
                                ...
                                onChange={(e) => handleNewRowInputChange("paramName", e.target.value)}
                                className="w-full border p-1"
                        ...
                        <td className="border p-2">
                            <select
                                ...
                                onChange={(e) => handleNewRowInputChange("paramType", e.target.value)}
                                className="w-full border p-1"
                            >
                                {paramTypes.map((type) => (
                                    <option key={type} value={type}>{type}</option>
                        ...
                        <td className="border p-2 text-center">
                            <input
                                ...
                                onChange={(e) => handleNewRowInputChange("mandatory", e.target.checked)}
                            />
                        </td>
                        <td className="border p-2 text-center">
                            <input
                                ...
                                onChange={(e) => handleNewRowInputChange("sensitive", e.target.checked)}
                            />
                        </td>
                        <td className="border p-2">
                            <input
                                ...
                                onChange={(e) => handleNewRowInputChange("variableName", e.target.value)}
                                className="w-full border p-1"
                        ...
                        <td className="border p-2">
                            <input
                                ...
                                onChange={(e) => handleNewRowInputChange("description", e.target.value)}
                                className="w-full border p-1"
